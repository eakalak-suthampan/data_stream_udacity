...
@app.agent(topic)
async def transformstation(connect_stations):
    async for station in connect_stations:
        if station.red:
            line = "red"
        elif station.blue:
            line = "blue"
            ...
            line = None
        transformed_table[station.station_id] = TransformedStation(station_id=station.station_id,
